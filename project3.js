...
function autoficoscore(score, autoInterestRate, maxAutoprice, maxAutoloan) {
  ...
  if (score < 300) {
    ...
    document.getElementById("fico").innerHTML="Your maximum vehicle price is $22,500.";
    ...
    index=4;
    autoPriceIndex=4;
    maxAutoloanInk8dex=4;
    document.getElementById("fico").innerHTML="Your maximum loan amount is $37,500.";
    document.getElementById("fico").innerHTML="Your maximum vehicle price is $75,000.";
